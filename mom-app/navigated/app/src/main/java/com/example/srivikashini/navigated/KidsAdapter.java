...
String url,postData;
    ...
    public KidsAdapter(Context context, String[] id, String[] kname, String[] kdob) {
        mContext = context;
        Id = id;
        kidnames = kname;
        dateofb = kdob;
        ...
        if (convertView == null) {
            ...
            mViewHolder.cv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SharedPreferences.Editor editor = mContext.getSharedPreferences(Constants.PREFS_FILE, MODE_PRIVATE).edit();
                    editor.putString("kidsId", Id[position]);
                    editor.apply();
