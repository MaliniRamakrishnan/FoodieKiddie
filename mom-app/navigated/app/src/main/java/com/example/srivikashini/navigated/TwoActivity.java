...
public class TwoActivity extends Fragment{
    ...
    ListView mainList;
    String[] itemids, itemString, priceString, typeString, picString, cuisineString;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        ItemsAdapter adapter = new ItemsAdapter(getContext(), itemids, itemString, priceString, typeString, picString, cuisineString);
        mainList = TwoActivity.this.getActivity().findViewById(R.id.mainList);
